...
class WechatJsapi extends BaseWechat
{
    ...
    */
    ...
    public function __construct($config)
    {
        ...
        isset($config['appid']) || json_error('缺少参数：jsapi_appid');
        isset($config['appsecret']) || json_error('缺少参数：jsapi_secret');
        $this->jsapiAppId = $config['appid'];
        $this->jsapiSecret = $config['appsecret'];
    }
