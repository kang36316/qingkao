<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\database\index.html";i:1547447008;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/database/backup'); ?>" class="layui-btn ajax-batch"><i class="fa fa-tags"></i> 立即备份</a>
            <a href="<?php echo url('admin/database/optimize'); ?>" class="layui-btn layui-btn-normal ajax-batch"><i class="fa fa-rocket"></i> 批量优化</a>
            <a href="<?php echo url('admin/database/repair'); ?>" class="layui-btn layui-btn-normal ajax-batch"><i class="fa fa-retweet"></i> 批量修复</a>
            <a href="<?php echo url('admin/database/import'); ?>" class="layui-btn layui-btn-primary"><i class="fa fa-database"></i> 数据列表</a>
        </div>
        <table class="layui-table layui-form">
            <thead>
                <tr>
                    <th width="20"><input type="checkbox" lay-skin="primary" lay-filter="*" checked="chedked"></th>
                    <th>表名</th>
                    <th>类型</th>
                    <th>记录</th>
                    <th>大小</th>
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="checkbox" name="table" value="<?php echo $v['name']; ?>" lay-skin="primary" checked="chedked"></td>
                    ...
                    <td>
                        <a href="<?php echo url('admin/database/optimize', ['table' => $v['name']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-action"><i class="fa fa-rocket"></i> 优化</a>
                        <a href="<?php echo url('admin/database/repair', ['table' => $v['name']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-action"><i class="fa fa-retweet"></i> 修复</a>
                    </td>
                </tr>
