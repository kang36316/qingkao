<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\weixinpay.html";i:1581221422;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1581221312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card-body">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li class="layui-this">扫码支付</li>
                <li>H5支付</li>
                <li>APP支付</li>
            </ul>
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <label class="layui-form-label">appid</label>
                            <div class="layui-input-block">
                                <input type="text" name="weixin_appid" value="<?php echo (isset($data['weixin_appid']) && ($data['weixin_appid'] !== '')?$data['weixin_appid']:''); ?>" placeholder="请输入appid" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">mch_id</label>
                            <div class="layui-input-block">
                                <input type="text" name="weixin_mch_id" value="<?php echo (isset($data['weixin_mch_id']) && ($data['weixin_mch_id'] !== '')?$data['weixin_mch_id']:''); ?>" placeholder="请输入mch_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">key</label>
                            <div class="layui-input-block">
                                <input type="text" name="weixin_key" value="<?php echo (isset($data['weixin_key']) && ($data['weixin_key'] !== '')?$data['weixin_key']:''); ?>" placeholder="请输入key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">AppSecret</label>
                            <div class="layui-input-block">
                                <input type="text" name="weixin_AppSecret" value="<?php echo (isset($data['weixin_AppSecret']) && ($data['weixin_AppSecret'] !== '')?$data['weixin_AppSecret']:''); ?>" placeholder="请输入AppSecret" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                ...
                <div class="layui-tab-item">
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <label class="layui-form-label">appid</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_weixin_appid" value="<?php echo (isset($data['h5_weixin_appid']) && ($data['h5_weixin_appid'] !== '')?$data['h5_weixin_appid']:''); ?>" placeholder="请输入app_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">mch_id</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_weixin_mch_id" value="<?php echo (isset($data['h5_weixin_mch_id']) && ($data['h5_weixin_mch_id'] !== '')?$data['h5_weixin_mch_id']:''); ?>" placeholder="请输入商户号" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">key</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_weixin_key" value="<?php echo (isset($data['h5_weixin_key']) && ($data['h5_weixin_key'] !== '')?$data['h5_weixin_key']:''); ?>" placeholder="请输入key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">AppSecret</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_weixin_AppSecret" value="<?php echo (isset($data['h5_weixin_AppSecret']) && ($data['h5_weixin_AppSecret'] !== '')?$data['h5_weixin_AppSecret']:''); ?>" placeholder="请输入AppSecret" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                ...
                <div class="layui-tab-item">
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <label class="layui-form-label">appid</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_weixin_appid" value="<?php echo (isset($data['app_weixin_appid']) && ($data['app_weixin_appid'] !== '')?$data['app_weixin_appid']:''); ?>" placeholder="请输入app_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">mch_id</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_weixin_mch_id" value="<?php echo (isset($data['app_weixin_mch_id']) && ($data['app_weixin_mch_id'] !== '')?$data['app_weixin_mch_id']:''); ?>" placeholder="请输入商户号" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">key</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_weixin_key" value="<?php echo (isset($data['app_weixin_key']) && ($data['app_weixin_key'] !== '')?$data['app_weixin_key']:''); ?>" placeholder="请输入public_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">AppSecret</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_weixin_AppSecret" value="<?php echo (isset($data['app_weixin_AppSecret']) && ($data['app_weixin_AppSecret'] !== '')?$data['app_weixin_AppSecret']:''); ?>" placeholder="请输入AppSecret" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
