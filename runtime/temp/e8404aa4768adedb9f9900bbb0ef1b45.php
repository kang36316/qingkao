<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/qingkao/public/../application/admin/view/course/liveindex.html";i:1581221312;s:53:"/www/wwwroot/qingkao/application/admin/view/base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="cid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if(input('cid') == $v['id']): ?>selected="selected"<?php endif; ?>><?php if($v['level'] != '1'): ?>|<?php $__FOR_START_521053294__=1;$__FOR_END_521053294__=$v['level'];for($i=$__FOR_START_521053294__;$i < $__FOR_END_521053294__;$i+=1){ ?> &#45;&#45;&#45;&#45;<?php } endif; ?> <?php echo $v['category_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
