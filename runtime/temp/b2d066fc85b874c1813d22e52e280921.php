<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\database\import.html";i:1547447008;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <table class="layui-table layui-form">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $key; ?></td>
                    <td>
                        <a href="<?php echo url('admin/database/download', ['time' => $v['time']]); ?>" class="layui-btn layui-btn-xs"><i class="fa fa-download"></i> 下载</a>
                        <a href="<?php echo url('admin/database/import', ['time' => $v['time']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-action"><i class="fa fa-mail-reply-all"></i> 还原</a>
                        <a href="<?php echo url('admin/database/del', ['time' => $v['time']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                    </td>
                </tr>
