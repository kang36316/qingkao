<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\flashsale\index.html";i:1581221312;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/flashsale/create',['type'=>1]); ?>" class="layui-btn ajax-iframe" data-width="800px" data-height="500px"><i class="fa fa-plus-circle"></i> 创建课程抢购</a>
            <a href="<?php echo url('admin/flashsale/create',['type'=>2]); ?>" class="layui-btn layui-btn-normal ajax-iframe" data-width="800px" data-height="500px"><i class="fa fa-plus-circle"></i> 创建班级抢购</a>
            <a href="<?php echo url('admin/flashsale/del'); ?>" class="layui-btn layui-btn-danger ajax-batch"><i class="fa fa-trash-o"></i> 批量删除</a>
        </div>
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td><?php echo $v['details']['rate']; ?>折促销</td>
                <td><?php echo $v['details']['starttime']; ?></td>
                <td><?php echo $v['details']['endtime']; ?></td>
                <td><?php echo getFlashsaleStatus($v['details']['starttime'],$v['details']['endtime']); ?></td>
                <td><div class="layui-btn-group mb0">
                        <a href="<?php echo url('admin/flashsale/edit', ['id' => $v['id'],'ctype'=> $v['c_type']]); ?>" class="layui-btn layui-btn-xs ajax-iframe" data-width="800px" data-height="500px"> <i class="layui-icon">&#xe642;</i></a>
                        <a href="<?php echo url('admin/flashsale/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"> <i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
