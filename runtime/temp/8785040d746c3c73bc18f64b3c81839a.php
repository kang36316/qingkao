<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\card\index.html";i:1581221010;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-header">
        <form action="<?php echo url('admin/card/index'); ?>" class="layui-form" method="get">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <input type="text" name="number" value="<?php echo input('number'); ?>" autocomplete="off" placeholder="请输入卡号" class="layui-input"/>
                </div>
                <div class="layui-input-inline">
                    <select name="buystatus">
                        <option value="">是否导出</option>
                        <option value="1" <?php if(input('?buystatus') and (input('status') == 1)): ?> selected="selected"<?php endif; ?>>是</option>
                        <option value="0" <?php if(input('?buystatus') and (input('status') == 0)): ?> selected="selected"<?php endif; ?>>否</option>
                    </select>
                </div>
                <div class="layui-input-inline">
                    <select name="usestatus">
                        <option value="">是否使用</option>
                        <option value="1" <?php if(input('?usestatus') and (input('status') == 1)): ?> selected="selected"<?php endif; ?>>是</option>
                        <option value="0" <?php if(input('?usestatus') and (input('status') == 0)): ?> selected="selected"<?php endif; ?>>否</option>
                    </select>
                </div>
                <div class="layui-input-inline">
                    <select name="status">
                        <option value="">状态</option>
                        <option value="1" <?php if(input('?status') and (input('status') == 1)): ?> selected="selected"<?php endif; ?>>正常</option>
                        <option value="0" <?php if(input('?status') and (input('status') == 0)): ?> selected="selected"<?php endif; ?>>禁用</option>
                    </select>
                </div>
                <div>
    ...
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/card/add'); ?>" class="layui-btn ajax-iframe" data-width="600px" data-height="400px"><i class="fa fa-plus-circle"></i> 生成充值卡</a>
            <a href="<?php echo url('admin/card/del'); ?>" class="layui-btn layui-btn-danger ajax-batch"><i class="fa fa-trash-o"></i> 批量删除</a>
            <a href="<?php echo url('admin/card/edit',['name' => 'status', 'value' => '1']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-ban"></i> 设为禁用</a>
            <a href="<?php echo url('admin/card/edit',['name' => 'status', 'value' => '0']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-bullseye"></i> 取消禁用</a>
            <a href="<?php echo url('admin/card/edit',['name' => 'buystatus', 'value' => '1']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-flag-o"></i> 标记导出</a>
            <a href="<?php echo url('admin/card/edit',['name' => 'buystatus', 'value' => '0']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-close"></i> 取消导出</a>
            <a href="<?php echo url('admin/card/export'); ?>" class="layui-btn layui-btn-primary ajax-iframe" data-width="600px" data-height="400px"><i class="fa fa-file-excel-o"></i> 导出点卡</a>
        </div>
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td><?php if($v['buystatus']==0): ?>未导出<?php endif; if($v['buystatus']==1): ?>已导出<?php endif; ?></td>
                ...
                <td><a href="<?php echo url('admin/card/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"> <i class="layui-icon">&#xe640;</i></a></td>
            </tr>
