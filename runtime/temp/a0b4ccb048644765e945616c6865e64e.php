<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\course\videoaddExam.html";i:1560768650;s:65:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\iframe.html";i:1581220658;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form action="<?php echo request()->url(); ?>" class="layui-form mt30 mr50" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text"  name="paperid" value="<?php echo (isset($data['paperid']) && ($data['paperid'] !== '')?$data['paperid']:''); ?>" autocomplete="off" placeholder="请选择试卷" class="layui-input">
            <button href="<?php echo url('admin/course/paperlist'); ?>" type="button" class="layui-btn layui-btn-primary layui-btn-position ajax-iframe" data-width="600px" data-height="400px"><i class="fa fa-cloud"></i> 选择试卷</button>
        </div>
    </div>
    <!--<div class="layui-form-item">
