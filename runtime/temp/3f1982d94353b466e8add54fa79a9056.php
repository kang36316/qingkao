<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/qingkao/public/../application/admin/view/educloud/testconnect.html";i:1587285320;s:53:"/www/wwwroot/qingkao/application/admin/view/base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="upvideo-btn">
	<form enctype="multipart/form-data" action="/admin/educloud/uploadVideo" method="post">  
    <input type="file" name="file" value="" /> 
	
    <input type="submit" value="上传吧" class="onup"/>  
    <!--<br/><br/>  -->
