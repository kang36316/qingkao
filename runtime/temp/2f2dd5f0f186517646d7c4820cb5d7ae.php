<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\user\saveteacher.html";i:1587564158;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username" value="<?php echo (isset($data['username']) && ($data['username'] !== '')?$data['username']:''); ?>" autocomplete="off" placeholder="请输入用户名" lay-verify="required" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="headteacher" value="<?php echo (isset($data['headteacher']) && ($data['headteacher'] !== '')?$data['headteacher']:''); ?>" autocomplete="off" placeholder="请输入姓名" lay-verify="required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">* 性别</label>
                <div class="layui-input-block">
                    <input type="radio" name="sex" <?php if((isset($data['sex']) && ($data['sex'] !== '')?$data['sex']:1) == '1'): ?>checked<?php endif; ?> title="男" value="1" checked />
                    <input type="radio" name="sex" <?php if((isset($data['sex']) && ($data['sex'] !== '')?$data['sex']:2) == '2'): ?>checked<?php endif; ?> title="女" value="2" />
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">* 手机号</label>
                <div class="layui-input-inline">
                    <input type="text" name="mobile" value="<?php echo (isset($data['mobile']) && ($data['mobile'] !== '')?$data['mobile']:''); ?>" autocomplete="off" placeholder="请输入手机号" lay-verify="phone|number" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
