<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\educloud\liveBind.html";i:1581221348;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card-body">
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">Partner_ID</label>
                <div class="layui-input-block">
                    <input type="text" name="Partner_ID" value="<?php echo $data['Partner_ID']; ?>" lay-verify="required" autocomplete="off" placeholder="请填写直播账号Partner_ID" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">Partner_Key</label>
                <div class="layui-input-block">
                    <input type="text" name="Partner_Key" value="<?php echo $data['Partner_Key']; ?>" lay-verify="required" autocomplete="off" placeholder="请填写直播账号Partner_Key" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">Secret_Key</label>
                <div class="layui-input-block">
                    <input type="text" name="Secret_Key" value="<?php echo $data['Secret_Key']; ?>" lay-verify="required" autocomplete="off" placeholder="请填写直播账号Secret_Key" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">private_domain</label>
                <div class="layui-input-block">
                    <input type="text" name="private_domain" value="<?php echo $data['private_domain']; ?>" lay-verify="required|http" autocomplete="off" placeholder="请填写直播账号private_domain" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
