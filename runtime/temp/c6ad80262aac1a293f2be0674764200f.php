<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\educloud\playbackList.html";i:1581221312;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <input type="hidden" id="url" value="/admin/educloud/getplaybacklist/page/">
            <thead>
            <tr>
                <th style="width:20px;"><input type="checkbox" lay-skin="primary" lay-filter="*"></th>
                <th style="width:120px;">RoomId</th>
                <th style="width:160px;">回放标题</th>
                <th >视频状态</th>
                <th >视频时长</th>
                <th >观看次数</th>
            ...
            <tr>
                ...
                <td><?php echo getVideoStatus($v['status']); ?></td>
                <td><?php echo $v['length']; ?></td>
                <td><?php echo $v['play_times']; ?></td>
                <td>
                    <a href="<?php echo $v['play_url']; ?>" target="_blank" class="layui-btn layui-btn-xs"><i class="fa fa-trash-o"></i> 观看</a>
                    <a href="<?php echo url('admin/educloud/delPlayback', ['id' => $v['room_id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                </td>
            </tr>
