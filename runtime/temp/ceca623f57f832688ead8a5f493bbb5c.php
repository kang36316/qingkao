<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\user\teacherList.html";i:1587741712;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--                <th>目录ID</th>-->
            ...
            <tr>
                ...
                <td><?php if($v['sex']==1): ?>男<?php endif; if($v['sex']==2): ?>女<?php endif; ?></td>
                <td><?php echo $v['create_time']; ?></td>
                <td>
                    <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="启用|禁用" data-url="<?php echo url('admin/user/editteacher', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked"<?php endif; ?>>
                </td>
