<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\category\index.html";i:1560641548;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
	<div class="layui-card-body">
        <div class="layui-btn-group">
		    <a href="<?php echo url('admin/category/add'); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加分类</a>
        </div>
		<table class="layui-table layui-form">
			...
			<tr>
				<td><?php echo $v['id']; ?></td>
				<td><?php if($v['level'] != '1'): ?>|<?php for($i=1;$i<$v['level'];$i++){echo ' ----';} endif; ?> <?php echo $v['category_name']; ?></td>
				<td>
					<input type="text" name="sort_order" value="<?php echo $v['sort_order']; ?>" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/category/edit', ['id' => $v['id']]); ?>">
				</td>
				<td>
					<a href="<?php echo url('admin/category/edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal"><i class="fa fa-edit"></i> 编辑</a>
					<a href="<?php echo url('admin/category/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
				</td>
			</tr>
