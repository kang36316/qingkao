<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\payset.html";i:1581221312;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="bili" value="<?php echo (isset($data['bili']) && ($data['bili'] !== '')?$data['bili']:''); ?>" placeholder="填写0.1-0.9，比如0.3表示教师分3成" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
