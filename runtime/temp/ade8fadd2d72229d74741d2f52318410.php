<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\exam\questionsList.html";i:1581220650;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="questionchapterid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if(input('?questionknowsid') and (input('questionknowsid') == $v['id'])): ?>selected="selected"<?php endif; ?>><?php if($v['level'] != '1'): ?>|<?php $__FOR_START_1366629185__=1;$__FOR_END_1366629185__=$v['level'];for($i=$__FOR_START_1366629185__;$i < $__FOR_END_1366629185__;$i+=1){ ?> &#45;&#45;&#45;&#45;<?php } endif; ?> <?php echo $v['category_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
