<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\system.html";i:1547447008;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    ...
    <div class="layui-card-body">
        <form action="<?php echo url('admin/config/system'); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">网站状态</label>
                <div class="layui-input-block">
                    <input type="radio" name="website_status" value="1" title="开启" checked="checked">
                    <input type="radio" name="website_status" value="0" title="关闭" <?php if(isset($data['website_status']) and $data['website_status'] == '0'): ?>checked="checked"<?php endif; ?>>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">关闭原因</label>
                <div class="layui-input-block">
                    <textarea name="colse_explain" class="layui-textarea"><?php echo (isset($data['colse_explain']) && ($data['colse_explain'] !== '')?$data['colse_explain']:''); ?></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">后台分页数</label>
                <div class="layui-input-block">
                    <input type="text" name="page_number" value="<?php echo (isset($data['page_number']) && ($data['page_number'] !== '')?$data['page_number']:''); ?>" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
