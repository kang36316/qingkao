<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\index.html";i:1560589672;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-header">
        <form action="<?php echo url('admin/config/index'); ?>" class="layui-form" method="get">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="group">
                        ...
                        <?php $_5e9177beef8b3=config('configGroup'); if(is_array($_5e9177beef8b3) || $_5e9177beef8b3 instanceof \think\Collection || $_5e9177beef8b3 instanceof \think\Paginator): if( count($_5e9177beef8b3)==0 ) : echo "" ;else: foreach($_5e9177beef8b3 as $k=>$v): ?>
                        <option value="<?php echo $k; ?>" <?php if(input('group') == $k): ?>selected="selected"<?php endif; ?>><?php echo $v; ?>[<?php echo $k; ?>]</option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
    ...
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/config/add'); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加配置</a>
        </div>
        <table class="layui-table layui-form">
            ...
            <tr>
                <td><?php echo $v['id']; ?></td>
                <td><?php echo config('configGroup')[$v['group']]; ?>[<?php echo $v['group']; ?>]</td>
                <td><?php echo $v['title']; ?></td>
                <td><?php echo $v['name']; ?></td>
                <td><?php echo config('configType')[$v['type']]; ?>[<?php echo $v['type']; ?>]</td>
                <td>config('<?php echo $v['group']; ?>.<?php echo $v['name']; ?>')</td>
                <td>
                    <input type="text" name="sort_order" value="<?php echo $v['sort_order']; ?>" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/config/edit', ['id' => $v['id']]); ?>">
                </td>
                <td>
                    <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="启用|禁用" data-url="<?php echo url('admin/config/edit', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked"<?php endif; ?>>
                </td>
                <td>
                    <a href="<?php echo url('admin/config/edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal"><i class="fa fa-edit"></i> 编辑</a>
                    <a href="<?php echo url('admin/config/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
