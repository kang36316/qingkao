<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\educloud\signName.html";i:1581220684;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="SmsSign" value="<?php echo $data['value']; ?>" lay-verify="required" autocomplete="off" placeholder="请填写短信签名" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
