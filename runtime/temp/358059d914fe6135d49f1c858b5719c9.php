<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\user\ordinance.html";i:1557034818;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-header">教师申请条例</div>
    <div class="layui-card-body">
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                <div class="">
                    <textarea name="value" placeholder="请输入详情内容" id="editor" style="height:400px;"><?php echo (isset($ordinance['value']) && ($ordinance['value'] !== '')?$ordinance['value']:''); ?></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="">
                    <input type="hidden" name="id" value="<?php echo $ordinance['id']; ?>">
