<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\exam\paperList.html";i:1581220650;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-header">
        <form action="<?php echo url('admin/exam/paperList'); ?>" class="layui-form" method="get">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <select name="cid">
                        <option value="">全部课程</option>
                        <?php if(is_array($course) || $course instanceof \think\Collection || $course instanceof \think\Paginator): if( count($course)==0 ) : echo "" ;else: foreach($course as $key=>$v): ?>
                        <option value="<?php echo $v['type']; ?>-<?php echo $v['id']; ?>" <?php if(input('cid') ==  $v['type'].'-'.$v['id']): ?>selected="selected"<?php endif; ?>><?php echo $v['title']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div>
    ...
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <tr>
                <td><?php echo $v['id']; ?></td>
                <td><?php echo get_exam_title($v['eid']); ?></td>
                <td><?php echo getCourseName($v['cid'],$v['ctype']); ?></td>
                <td><?php echo getUserName($v['uid']); ?></td>
                <td><?php echo markstatus($v['status']); ?></td>
                <td><?php echo $v['totalscores']; ?>分</td>
                <td><?php echo $v['addtime']; ?></td>
                <td>
                    <div class="layui-btn-group mb0">
                        <a href="<?php echo url('admin/exam/mark', ['id'=>$v['id'],'eid' => $v['eid'],'uid'=>$v['uid']]); ?>" class="layui-btn layui-btn-xs ajax-iframe" data-width="800px" data-height="500px">
