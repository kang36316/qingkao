<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\setting.html";i:1581221422;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <select name="<?php echo hashids_encode($config['id']); ?>">
                                    <?php $_5e917258840ae=parse_attr($config['options']); if(is_array($_5e917258840ae) || $_5e917258840ae instanceof \think\Collection || $_5e917258840ae instanceof \think\Paginator): if( count($_5e917258840ae)==0 ) : echo "" ;else: foreach($_5e917258840ae as $i=>$j): ?>
                                    <option value="<?php echo $i; ?>" <?php if($config['value'] == $i): ?>selected="selected"<?php endif; ?>><?php echo $j; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <?php endif; if($config['type'] == 'radio'): $_5e9172588408d=parse_attr($config['options']); if(is_array($_5e9172588408d) || $_5e9172588408d instanceof \think\Collection || $_5e9172588408d instanceof \think\Paginator): if( count($_5e9172588408d)==0 ) : echo "" ;else: foreach($_5e9172588408d as $i=>$j): ?>
