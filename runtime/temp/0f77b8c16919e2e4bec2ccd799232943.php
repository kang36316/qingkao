<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\forum\plate.html";i:1552403430;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
	<div class="layui-card-body">
        <div class="layui-btn-group">
		    <a href="<?php echo url('admin/forum/addplate'); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加板块</a>
        </div>
		<table class="layui-table layui-form">
			...
			<tr>
				...
				<td>
					<input type="text" name="sort_order" value="<?php echo $v['sort_order']; ?>" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/forum/editplate', ['id' => $v['id']]); ?>">
				</td>
				<td>
					<a href="<?php echo url('admin/forum/editplate', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal"><i class="fa fa-edit"></i> 编辑</a>
					<a href="<?php echo url('admin/forum/delplate', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
				</td>
			</tr>
