<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\educloud\getliveroomlist.html";i:1581221312;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td><?php echo getLIveType($v['type']); ?></td>
                <td><?php echo $v['start_time']; ?></td>
                <td><?php echo $v['teacher_code']; ?></td>
                <td><?php echo $v['admin_code']; ?></td>
                <td><?php echo $v['student_code']; ?></td>
                <td>
                    <a href="<?php echo url('admin/educloud/delLiveroom', ['id' => $v['room_id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                </td>
            </tr>
