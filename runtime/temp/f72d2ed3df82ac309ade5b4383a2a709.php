<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\article\index.html";i:1559049268;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="cid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if(input('cid') == $v['id']): ?>selected="selected"<?php endif; ?>><?php if($v['level'] != '1'): ?>|<?php $__FOR_START_2000787066__=1;$__FOR_END_2000787066__=$v['level'];for($i=$__FOR_START_2000787066__;$i < $__FOR_END_2000787066__;$i+=1){ ?> ----<?php } endif; ?> <?php echo $v['category_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
    ...
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/article/add', ['cid' => input('cid')]); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加数据</a>
            <a href="<?php echo url('admin/article/del'); ?>" class="layui-btn layui-btn-danger ajax-batch"><i class="fa fa-trash-o"></i> 批量删除</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'is_top', 'value' => '1']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-star"></i> 设置置顶</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'is_top', 'value' => '0']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-times-circle"></i> 取消置顶</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'is_hot', 'value' => '1']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-thumbs-up"></i> 设置推荐</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'is_hot', 'value' => '0']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-times-circle"></i> 取消推荐</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'status', 'value' => '1']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-send"></i> 设置发布</a>
            <a href="<?php echo url('admin/article/edit', ['name' => 'status', 'value' => '0']); ?>" class="layui-btn layui-btn-primary ajax-batch"><i class="fa fa-times-circle"></i> 取消发布</a>
        </div>
        <table class="layui-table layui-form">
            <thead>
                <tr>
                    <th><input type="checkbox" lay-skin="primary" lay-filter="*"></th>
                    <th style="width:20px;">ID</th>
                    <th style="width:60px;">分类</th>
                    <th>标题</th>
                    <th style="width:40px;">点击</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="sort_order" value="<?php echo $v['sort_order']; ?>" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/article/edit', ['id' => $v['id']]); ?>">
                    </td>
                    <td>
                        <input type="checkbox" name="is_top" lay-skin="switch" lay-filter="*" lay-text="是|否" data-url="<?php echo url('admin/article/edit', ['id' => $v['id']]); ?>" <?php if($v['is_top'] == 1): ?>checked="checked" <?php endif; ?>>
                    </td>
                    <td>
                        <input type="checkbox" name="is_hot" lay-skin="switch" lay-filter="*" lay-text="是|否" data-url="<?php echo url('admin/article/edit', ['id' => $v['id']]); ?>" <?php if($v['is_hot'] == 1): ?>checked="checked" <?php endif; ?>>
                    </td>
                    <td>
                        <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="启用|禁用" data-url="<?php echo url('admin/article/edit', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked" <?php endif; ?>>
                    </td>
                    <td>
                        <div class="layui-btn-group mb0">
                            <a href="<?php echo url('admin/article/edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs"> <i class="layui-icon">&#xe642;</i></a>
                            <a href="<?php echo url('admin/article/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"> <i class="layui-icon">&#xe640;</i></a>
                        </div>
                    </td>
                </tr>
