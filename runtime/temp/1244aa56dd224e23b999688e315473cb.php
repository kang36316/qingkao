<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\user\teacherList.html";i:1587566154;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <div class="layui-btn-group fl">
            <a href="<?php echo url('admin/user/addteacher'); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加教师</a>
...
<!--            <a href="<?php echo url('admin/user/export'); ?>" class="layui-btn layui-btn-primary"><i class="fa fa-file-excel-o"></i> 导出会员</a>-->
        ...
        <div class="fl ml20">
            <form action="<?php echo url('admin/user/teacherList'); ?>" class="layui-form" method="get" style="padding:0px;">
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="text" name="key" value="<?php echo input('key'); ?>" autocomplete="off" placeholder="用教师名或手机号搜索" class="layui-input"/>
                    </div>
                    <div class="fl">
...
<!--                <th>目录ID</th>-->
            ...
            <tr>
                ...
                <td><?php echo $v['info']['mobile']; ?></td>
                <td><?php echo $v['info']['sex']; ?></td>
<!--                <td><?php echo $v['info']['birth_y']; ?><?php echo $v['info']['birth_m']; ?><?php echo $v['info']['birth_d']; ?></td>-->
                <td><?php echo $v['info']['addtime']; ?></td>
<!--                <td><?php echo $v['category_id']; ?></td>-->
                <!--<td>
                    <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="启用|禁用" data-url="<?php echo url('admin/user/verify', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked"<?php endif; ?>>
                </td>-->
                <td>
                    <div class="layui-btn-group mb0">
                        <a href="<?php echo url('admin/user/editteacher', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs"> <i class="layui-icon">&#xe642;</i></a>
<!--                        <a href="<?php echo url('admin/user/addmoney', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs  layui-btn-normal  ajax-iframe" data-width="600px" data-height="400px" data-type="admin"><i class="layui-icon">&#xe65e;</i></a>-->
                        ...
                        <a href="<?php echo url('admin/user/delteacher', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"> <i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
