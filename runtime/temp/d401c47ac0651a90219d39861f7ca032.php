<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\user\teacher.html";i:1560842934;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td><?php echo $v['birth_y']; ?><?php echo $v['birth_m']; ?><?php echo $v['birth_d']; ?></td>
                <!--<td><?php echo $v['provid']; ?><?php echo $v['cityid']; ?><?php echo $v['areaid']; ?></td>-->
                <td><?php echo $v['addtime']; ?></td>
                <td><?php echo getCategoryId($v['id']); ?></td>
                <td>
                    <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="已审|待审" data-url="<?php echo url('admin/user/verify', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked"<?php endif; ?>>
                </td>
                <td>
                    <a href="<?php echo url('admin/user/details', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-iframe" data-width="800px" data-height="500px"><i class="fa fa-edit"></i> 详情</a>
                    <a href="<?php echo url('admin/user/delverify', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                </td>
            </tr>
