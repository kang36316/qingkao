<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\course\categorySave.html";i:1559897950;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card-body">
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="pid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if(isset($data) and $data['pid'] == $v['id'] or input('pid') == $v['id']): ?>selected="selected"<?php endif; ?>> <?php echo $v['cname']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="category_name" value="<?php echo (isset($data['category_name']) && ($data['category_name'] !== '')?$data['category_name']:''); ?>" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="keywords" value="<?php echo (isset($data['keywords']) && ($data['keywords'] !== '')?$data['keywords']:''); ?>" autocomplete="off" placeholder="请输入关键字" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">描述</label>
                <div class="layui-input-block">
                    <textarea name="description" autocomplete="off" placeholder="请输入描述" class="layui-textarea"><?php echo (isset($data['description']) && ($data['description'] !== '')?$data['description']:''); ?></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
