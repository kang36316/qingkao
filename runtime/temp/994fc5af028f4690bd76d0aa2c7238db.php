<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\mobileterminal\index.html";i:1581221348;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <tr>
                <td>APP安卓版</td>
                <td><?php if(empty($Android['domain'])): ?>未申请
                    <?php elseif(empty($Android['downurl']) and empty($Android['brief'])): ?>待审核
                    <?php elseif(empty($Android['downurl']) and !empty($Android['brief'])): ?>审核未过
                    <?php else: ?>审核通过
                    <?php endif; ?></td>
                <th><?php echo (isset($Android['brief']) && ($Android['brief'] !== '')?$Android['brief']:"待审"); ?></th>
                <th><?php echo $Android['version']; ?></th>
                <td><a href="<?php echo url('admin/Mobileterminal/app'); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-iframe" data-width="700px" data-height="500px"><i class="fa fa-edit"></i>申请</a><a href="https://demo.newlogo.cn" target="_blank" class="bt-ico-ask">?</a></td>
            </tr>
            <!--<tr>
                <td>微信小程序</td>
                <td><?php if(empty($Weixinxcx['domain'])): ?>未申请
                    <?php elseif(empty($Weixinxcx['downurl'])): ?>待审核
                    <?php else: ?>审核通过
                    <?php endif; ?></td>
                <th>说明</th>
                <th><?php echo $Weixinxcx['version']; ?></th>
                <td><a href="<?php echo url('admin/Mobileterminal/weixinxcx'); ?>" class="layui-btn layui-btn-xs layui-btn-normal ajax-iframe" data-width="600px" data-height="400px"><i class="fa fa-edit"></i>申请</a><a href="https://www.newlogo.cn/help.html" target="_blank" class="bt-ico-ask">?</a></td>
            </tr>-->
            </tbody>
        </table>
    </div>
