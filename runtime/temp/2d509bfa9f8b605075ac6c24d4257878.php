<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\article\index.html";i:1559049268;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="cid">
                        ...
                        <option value="<?php echo $v['id']; ?>" <?php if(input('cid') == $v['id']): ?>selected="selected"<?php endif; ?>><?php if($v['level'] != '1'): ?>|<?php $__FOR_START_42006610__=1;$__FOR_END_42006610__=$v['level'];for($i=$__FOR_START_42006610__;$i < $__FOR_END_42006610__;$i+=1){ ?> ----<?php } endif; ?> <?php echo $v['category_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
