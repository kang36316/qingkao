<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\mobileterminal\mobile.html";i:1581221348;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-body">
        <table class="layui-table layui-form">
            ...
            <tr>
                <td>移动手机端</td>
                <th><?php echo $h5version; ?></th>
                <th><?php echo $H5['version']; ?></th>
                <td>
                    <input type="hidden" id="lastVersion" value="<?php echo $H5['version']; ?>">
                    <input type="hidden" id="nowVesion" value="<?php echo $h5version; ?>">
                    <a  class="layui-btn layui-btn-xs layui-btn-normal upversion"  upurl="<?php echo url('admin/Mobileterminal/downMobile',['newversion'=>$H5['version'],'notes'=>$H5['notes']]); ?>"><i class="fa fa-edit"></i>下载</a><a href="https://demo.newlogo.cn" target="_blank" class="bt-ico-ask">?</a>
                </td>
            </tr>
            </tbody>
        </table>
