<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\ad\save.html";i:1547447008;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1586589106;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form action="<?php echo request()->url(); ?>" class="layui-form" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="image" value="<?php echo (isset($data['image']) && ($data['image'] !== '')?$data['image']:''); ?>" autocomplete="off" placeholder="请上传图片" class="layui-input">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="category">
                        ...
                        <option value="<?php echo $k; ?>" <?php if(isset($data) and $data['category'] == $k): ?>selected="selected"<?php endif; ?>><?php echo $v; ?>[<?php echo $k; ?>]</option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="url" value="<?php echo (isset($data['url']) && ($data['url'] !== '')?$data['url']:''); ?>" autocomplete="off" placeholder="http://" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
