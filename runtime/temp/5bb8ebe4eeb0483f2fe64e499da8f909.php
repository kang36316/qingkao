<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\qingkao\public/../application/admin\view\config\alipay.html";i:1581221312;s:60:"D:\phpstudy_pro\WWW\qingkao\application\admin\view\base.html";i:1581221312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="alipay_app_id" value="<?php echo (isset($data['alipay_app_id']) && ($data['alipay_app_id'] !== '')?$data['alipay_app_id']:''); ?>" placeholder="请输入app_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">private_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="alipay_rsa_private_key" value="<?php echo (isset($data['alipay_rsa_private_key']) && ($data['alipay_rsa_private_key'] !== '')?$data['alipay_rsa_private_key']:''); ?>" placeholder="请输入rsa_private_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">public_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="alipay_public_key" value="<?php echo (isset($data['alipay_public_key']) && ($data['alipay_public_key'] !== '')?$data['alipay_public_key']:''); ?>" placeholder="请输入public_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                ...
                <div class="layui-tab-item">
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <label class="layui-form-label">app_id</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_alipay_app_id" value="<?php echo (isset($data['h5_alipay_app_id']) && ($data['h5_alipay_app_id'] !== '')?$data['h5_alipay_app_id']:''); ?>" placeholder="请输入app_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">private_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_alipay_rsa_private_key" value="<?php echo (isset($data['h5_alipay_rsa_private_key']) && ($data['h5_alipay_rsa_private_key'] !== '')?$data['h5_alipay_rsa_private_key']:''); ?>" placeholder="请输入rsa_private_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">public_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="h5_alipay_public_key" value="<?php echo (isset($data['h5_alipay_public_key']) && ($data['h5_alipay_public_key'] !== '')?$data['h5_alipay_public_key']:''); ?>" placeholder="请输入public_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                ...
                <div class="layui-tab-item">
                    <form action="<?php echo url('admin/config/pay'); ?>" class="layui-form" method="post">
                        <div class="layui-form-item">
                            <label class="layui-form-label">app_id</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_alipay_app_id" value="<?php echo (isset($data['app_alipay_app_id']) && ($data['app_alipay_app_id'] !== '')?$data['app_alipay_app_id']:''); ?>" placeholder="请输入app_id" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">private_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_alipay_rsa_private_key" value="<?php echo (isset($data['app_alipay_rsa_private_key']) && ($data['app_alipay_rsa_private_key'] !== '')?$data['app_alipay_rsa_private_key']:''); ?>" placeholder="请输入rsa_private_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">public_key</label>
                            <div class="layui-input-block">
                                <input type="text" name="app_alipay_public_key" value="<?php echo (isset($data['app_alipay_public_key']) && ($data['app_alipay_public_key'] !== '')?$data['app_alipay_public_key']:''); ?>" placeholder="请输入public_key" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
