<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/qingkao/public/../application/admin/view/config/setting.html";i:1581221422;s:53:"/www/wwwroot/qingkao/application/admin/view/base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <select name="<?php echo hashids_encode($config['id']); ?>">
                                    <?php $_5e9c11fa93bd7=parse_attr($config['options']); if(is_array($_5e9c11fa93bd7) || $_5e9c11fa93bd7 instanceof \think\Collection || $_5e9c11fa93bd7 instanceof \think\Paginator): if( count($_5e9c11fa93bd7)==0 ) : echo "" ;else: foreach($_5e9c11fa93bd7 as $i=>$j): ?>
                                    <option value="<?php echo $i; ?>" <?php if($config['value'] == $i): ?>selected="selected"<?php endif; ?>><?php echo $j; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <?php endif; if($config['type'] == 'radio'): $_5e9c11fa93bbb=parse_attr($config['options']); if(is_array($_5e9c11fa93bbb) || $_5e9c11fa93bbb instanceof \think\Collection || $_5e9c11fa93bbb instanceof \think\Paginator): if( count($_5e9c11fa93bbb)==0 ) : echo "" ;else: foreach($_5e9c11fa93bbb as $i=>$j): ?>
