<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpstudy_pro\WWW\qingkaoedu\public/../application/admin\view\ad\index.html";i:1550297436;s:63:"D:\phpstudy_pro\WWW\qingkaoedu\application\admin\view\base.html";i:1586589108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-card">
    <div class="layui-card-header">
        <form action="<?php echo url('admin/ad/index'); ?>" class="layui-form" method="get">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <input name="name" type="text" placeholder="请输入广告名称" autocomplete="off" value="<?php echo input('name'); ?>" class="layui-input" />
                </div>
                <div class="layui-input-inline">
                    <select name="category">
                        ...
                        <option value="<?php echo $k; ?>" <?php if(input('category') == $k): ?>selected="selected"<?php endif; ?>><?php echo $v; ?>[<?php echo $k; ?>]</option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline">
    ...
    <div class="layui-card-body">
        <div class="layui-btn-group">
            <a href="<?php echo url('admin/ad/add'); ?>" class="layui-btn"><i class="fa fa-plus-circle"></i> 添加广告</a>
        </div>
        <table class="layui-table layui-form">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    <td><?php echo $category[$v['category']]; ?>[<?php echo $v['category']; ?>]</td>
                    <td>
                        <?php if(empty($v['image'])): ?>
                        <img src="/static/img/no_image_50x50.jpg"/>
                        <?php else: ?>
                    ...
                    <td>
                        <input type="text" name="sort_order" value="<?php echo $v['sort_order']; ?>" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/ad/edit', ['id' => $v['id']]); ?>">
                    </td>
                    <td>
                        <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="启用|禁用" data-url="<?php echo url('admin/ad/edit', ['id' => $v['id']]); ?>" <?php if($v['status'] == 1): ?>checked="checked"<?php endif; ?>>
                    </td>
                    <td>
                        <a href="<?php echo url('admin/ad/edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-normal"><i class="fa fa-edit"></i> 编辑</a>
                        <a href="<?php echo url('admin/ad/del', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-xs layui-btn-danger ajax-delete"><i class="fa fa-trash-o"></i> 删除</a>
                    </td>
                </tr>
